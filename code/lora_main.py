...
from config import device, seed, lora_num_epochs, lora_train_batch_size, lora_eval_batch_size, lora_lr
...
from lora_training import train_lora_model, compute_metrics, SaveModelCallback, load_model_from_epoch, dp_train_lora_model
...
# # Train model with LoRA on standard dataset
# print("Training model with LoRA on standard dataset")
train_lora_model(datasets["train"], datasets["test"], tokenizer, training_args, device, model_type="distilbert-base-uncased-lora")
...
#     model = load_model_from_epoch(epoch, model_type="distilbert-base-uncased-lora-r480")
...
#         log_file.write("lora model non-dp trained with not modified dataset\n")
...
#     perform_mia_and_log_results(model, epoch, train_logits, train_labels, train_losses, test_logits, test_labels, test_losses, train_indices, test_indices, datasets, model_type="distilbert-base-uncased-lora-r480")

# # Train model with LoRA on modified dataset
# print("Training model with LoRA on modified dataset")
# train_lora_model(modified_train_dataset, modified_test_dataset, tokenizer, training_args, device, model_type="distilbert-base-uncased-lora-modified-r480")
...
# for epoch in [1.0, 3.0]:
#     model = load_model_from_epoch(epoch, model_type="distilbert-base-uncased-lora-modified-r480")
...
#     log_file_name = "model_performance.log"
#     with open(log_file_name, "a") as log_file:
#         log_file.write("lora model not dp trained with modified dataset\n")
#         log_file.write(f"Epoch {epoch}\n")
#         log_file.write(f"Accuracy: {accuracy}\n")
#         log_file.write(f"Precision: {precision}\n")
#         log_file.write(f"Recall: {precision}\n")
...
#     perform_mia_and_log_results(model, epoch, train_logits, train_labels, train_losses, test_logits, test_labels, test_losses, train_indices, test_indices, datasets, model_type="distilbert-base-uncased-lora-modified-r480")
...
for epsilon in [4.0]:
    ...
    dp_train_lora_model(datasets["train"], datasets["test"], tokenizer, training_args, privacy_args, device, model_type=f'dp-distilbert-base-uncased-epsilon-{epsilon}-lora')
    
#     for epoch in [1.0, 3.0]:
#         model = load_model_from_epoch(epoch, model_type=f'QNLI-dp-distilbert-base-uncased-epsilon-{epsilon}-lora-r480')
#         accuracy, precision, recall, f1 = evaluate(model, test_loader)
...
#         log_file_name = "model_performance.log"
#         with open(log_file_name, "a") as log_file:
#             log_file.write("lora model dp trained with not modified dataset\n")
#             log_file.write(f"Epoch {epoch}\n")
#             log_file.write(f"Accuracy: {accuracy}\n")
#             log_file.write(f"Precision: {precision}\n")
#             log_file.write(f"Recall: {precision}\n")
...
#         train_logits, train_labels, train_losses, _ = collect_logits_labels_losses(train_loader, model, torch.nn.CrossEntropyLoss(reduction="none"), train_indices, device)
#         test_logits, test_labels, test_losses, _ = collect_logits_labels_losses(test_loader, model, torch.nn.CrossEntropyLoss(reduction="none"), test_indices, device)
#         perform_mia_and_log_results(model, epoch, train_logits, train_labels, train_losses, test_logits, test_labels, test_losses, train_indices, test_indices, datasets, model_type=f'QNLI-dp-distilbert-base-uncased-epsilon-{epsilon}-lora-r480')
...
#     dp_train_lora_model(modified_train_dataset, modified_test_dataset, tokenizer, training_args, privacy_args, device, model_type=f'QNLI-dp-distilbert-base-uncased-epsilon-{epsilon}-lora-modified-r480')
    
#     for epoch in [1.0, 3.0]:
#         model = load_model_from_epoch(epoch, model_type=f'QNLI-dp-distilbert-base-uncased-epsilon-{epsilon}-lora-modified-r480')
#         accuracy, precision, recall, f1 = evaluate(model, modified_test_loader)
...
#         log_file_name = "model_performance.log"
#         with open(log_file_name, "a") as log_file:
#             log_file.write("lora model dp trained with modified dataset\n")
#             log_file.write(f"Epoch {epoch}\n")
#             log_file.write(f"Accuracy: {accuracy}\n")
#             log_file.write(f"Precision: {precision}\n")
#             log_file.write(f"Recall: {precision}\n")
...
#         train_logits, train_labels, train_losses, _ = collect_logits_labels_losses(modified_train_loader, model, torch.nn.CrossEntropyLoss(reduction="none"), train_indices, device)
#         test_logits, test_labels, test_losses, _ = collect_logits_labels_losses(modified_test_loader, model, torch.nn.CrossEntropyLoss(reduction="none"), test_indices, device)
#         perform_mia_and_log_results(model, epoch, train_logits, train_labels, train_losses, test_logits, test_labels, test_losses, train_indices, test_indices, datasets, model_type=f'QNLI-dp-distilbert-base-uncased-epsilon-{epsilon}-lora-modified-r480')